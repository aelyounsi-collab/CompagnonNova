    ...
    <div className="min-h-screen bg-zinc-950">
      ...
      <header className="border-b border-zinc-800 bg-zinc-950/80 backdrop-blur-sm sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-zinc-100 leading-none">Gospel Lip Sync Studio</h1>
              <p className="text-xs text-zinc-500 mt-0.5">AI-powered singing animation · V1</p>
            </div>
          </div>
      ...
      <div className="bg-gradient-to-b from-zinc-900 to-zinc-950 border-b border-zinc-800">
        <div className="max-w-4xl mx-auto px-4 py-10 text-center space-y-3">
          <h2 className="text-3xl md:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-500">
            Bring Gospel to Life
          </h2>
          <p className="text-zinc-400 max-w-xl mx-auto text-base">
            Upload a portrait and your song. We analyze the vocal intensity, segment the audio, and prepare a professional lip-sync job optimized for gospel singing.
          </p>
      ...
      <footer className="border-t border-zinc-800 mt-16">
        <div className="max-w-4xl mx-auto px-4 py-6 text-center text-xs text-zinc-600">
          Gospel Lip Sync Studio · V1 · Built with Next.js + TypeScript ·{' '}
